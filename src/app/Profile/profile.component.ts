...
export class ProfileComponent {
  ...
  recentylClaimed: { cover: string }[] = faker.helpers.multiple(
    this.createCaimed,
    {
      count: 4,
    }
  );
  randomAcheivements: Achievements[] = faker.helpers.multiple(
  ...
  ngOnInit() {
    //put js code here
    document.title = this.auth.currentUser.username;
  }
}
